...
{
    public class GenerateModFromBuildFilesModalWindow : ReactiveWindow<GenerateModFromBuildFilesModalWindowViewModel>
    {
        ...
        public GenerateModFromBuildFilesModalWindow()
        {
            InitializeComponent();
        }
